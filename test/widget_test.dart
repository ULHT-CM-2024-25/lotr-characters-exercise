...
/// Runs the test with or without network image mocking, depending on test type.
Future<void> runTest(Future<void> Function() testBody) async {
  bool isWidgetTest = Platform.environment.containsKey('FLUTTER_TEST');

  if (isWidgetTest) {
    await mockNetworkImagesFor(testBody);
  } else {
    await testBody();
  }
}
